...
try{
        ...
        if (!strIdMetodo.isEmpty()){
    	 ...
    	 TBTipoAtributo ctm = ctrlTba.obtenerByID(T_atributo);
    	 ASClase cClase = ctrlTbtc.obtenerByID(idClase);
    	 ASMetodo cMetodo = ctrlAsm.obtenerByID(idMetodo);
   	
    	 
    		
    	 ASAtributo asc = new ASAtributo(idClase,idAtributo,Atributo,T_d_atributo,Usuario,Fecha,cClase,cMetodo,ctm,idMetodo);
