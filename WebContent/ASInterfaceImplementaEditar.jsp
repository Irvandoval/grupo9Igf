...
CtrlASInterface crtlinterf1 = (CtrlASInterface) ac .getBean("ctrlASInterface");
...
ASInterface interf1 = crtlinterf1.obtenerByID(idHijo); 
ASInterface interf2 = crtlinterf2.obtenerByID(idPadre);
	
ASInterfaceImplementa asii = new ASInterfaceImplementa(idClase,interf1,interf2);
Boolean estado = ctrlasii.editar(asii);
...
<%= mensaje %>
<a href="/TareaIGFGrupo09/ASInterfaceImplementaPpal.jsp" class="btn btn-success">Aceptar</a>
</body>
</html>