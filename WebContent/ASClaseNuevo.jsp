...
<body>
	...
	<div id="nuevo" class="content text-center">
		<h2>Nuevo ASClase</h2>
		<form
			action="http://localhost:8080/TareaIGFGrupo09/ASClaseInsertar.jsp">
			<div class="form-group">
				<label for="usr">id as_clase:</label> <input type="text"
					class="form-control text-center" name="id_as_clase">
			</div>
			<div class="form-group">
