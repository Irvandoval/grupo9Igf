...
TBAplicativo tbtc = ctrlTbtc.obtenerByID(id);
%>
...
<div id="nuevo" class="content text-center">
	<h2>Editar TBTipoClase</h2>
		<form action="http://localhost:8080/TareaIGFGrupo09/TPAplicativoEditar.jsp">
			<div class="form-group">
				<label for="usr">id:</label> 
				<input type="text" class="form-control text-center" name="id" value="<%= tbtc.getcAplicativo() %>" readonly="readonly" />
			</div>
			<div class="form-group">
				<label for="usr">nombre:</label> <input type="text"
					class="form-control text-center" name="nombre" value="<%= tbtc.getdAplicativo() %>">
			</div>
			<div class="form-group">
