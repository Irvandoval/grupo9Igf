		...
		<form 
			...
			<div class="form-group">
				<label for="usr">id clase:</label> <select name="id_clase"
					...
					<c:forEach var="ASAtributo" items="${listaASClase}">
						<option value='${ASAtributo.cClase}'>
							<c:out value="${ASAtributo.cClase}"></c:out>
						</option>
			...
			<div class="form-group">
				<label for="usr">id metodo:</label> <select name="id_metodo"
					...
					<c:forEach var="ASAtributo" items="${listaASMetodo}">
						<option value='${ASAtributo.cMetodo}'>
							<c:out value="${ASAtributo.cMetodo}"></c:out>
						</option>
